...
#input data
train_df=pd.read_json('/Users/ChienMingHuang/Desktop/Kaggle/train.json')
test_df=pd.read_json('/Users/ChienMingHuang/Desktop/Kaggle/test.json')
...
out_df.to_csv("/Users/ChienMingHuang/Desktop/Kaggle/xgboost.csv", index=False)     